...
class AlamofireAPIHelper {
    ...
    func deleteRequest<T, P>( params: P, url: URL, headers: HTTPHeaders, responseType: T.Type) -> AnyPublisher<DataResponse<T, NetworkError>, Never> where T : Decodable, P : Encodable {
