...
struct AppPreviewModels {
    ...
    static let photo_message = MessageViewModel(message: MessageModel(id: 1, createdAt: "2022-04-22 21:47:38.123", updatedAt: "2022-05-01 16:35:00.123", message: "https://meetraapp.s3.us-east-2.amazonaws.com/users/karen-1648577225513.jpg", type: "photo", status: "sent", isEdited: false, replyedTo: RepliedModel(messageId: 1, message: "Окей)", senderName: "Karen", type: "text"), sender: MessageSenderModel(id: 1, name: "Karen", online: true)))
