...
struct AppPreviewModels {
    ...
    static let placeRoom =  PlaceRoom(users: [UserPreviewModel(id: 1, image: "https://meetraapp.s3.us-east-2.amazonaws.com/users/karen-1648577225513.jpg", name: "Karen", age: 22, online: true),
                                              ...
                                              UserPreviewModel(id: 11, image: "https://meetraapp.s3.us-east-2.amazonaws.com/users/karen-1648577225513.jpg", name: "Karen", age: 22, online: true)], chat: PlaceChat(id: 9, name: "EVN", isGroup: true, members: 3, online: 3, left: true), count: 1)
