...
struct AppPreviewModels {
    ...
    static let fields = ProfileEditFields(name: "KarenMirakyan", bio: "IOS Developer with over 2 years of experience", occupation: "Бариста", school: "", gender: "Мужчина", location: "", interests: ["Coffee"])
